...
if ($hour >= 5 && $hour < 12)       $greeting = 'Доброе утро, инженер';
elseif ($hour >= 12 && $hour < 18)  $greeting = 'Добрый день, разработчик';
elseif ($hour >= 18 && $hour < 23)  $greeting = 'Добрый вечер, кодер';
else                                 $greeting = 'Ещё не спишь, коллега?';
