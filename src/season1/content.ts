import type { CharacterDefinition, FocusDefinition, ModeDefinition, SlotDefinition, Weekday } from './types.js';
...
export const LIFE_MODES: ModeDefinition[] = [
    {
        id: 'survival',
        label: 'Выживание',
...
export const PROJECT_FOCUSES: FocusDefinition[] = [
...
export const SLOT_OPTIONS: SlotDefinition[] = [
