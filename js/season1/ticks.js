...
export function resolveDays(state, count) {
...
function completeProject(state) {
    const p = state.activeProject;
...
function tryUnlockCharacters(state) {
...
function tryUpgradeStudio(state) {
...
function pushEvent(state, title, body, kind) {
