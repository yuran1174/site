...
**Что сделано:**
- Добавлен `docs/game/season-1-act-1-progression-map.md`, который связывает сценарный акт 1, day loop и character roster в одну последовательность игровых beat'ов
- Для каждого узла зафиксированы стартовое состояние, доступные действия, открывающаяся сцена, системный эффект и следующий unlock
- Описаны системные требования к финалу акта 1, MVP-версия vertical slice и правила темпа между крупными сценами
- В `TODO.md` добавлена и закрыта задача `TASK-066`

**Файлы затронуты:**
- `docs/game/season-1-act-1-progression-map.md` (создан)
- `TODO.md` (обновлён)
- `.claude/CHANGELOG.md` (обновлён)
